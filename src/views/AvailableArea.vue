<template>
  <div class="py-4">
    <!-- <h1 class="text-3xl text-center font-bold mt-6 text-gray-700">
      {{ campgroundName }}
    </h1> -->
    <div
    ...
    >
      ...
      <div class="py-4 px-6">
        ...
        <button
          class="bg-[#E6BB96] font-bold text-gray-800 py-2 px-4 rounded hover:bg-[#8C9579] focus:outline-none focus:shadow-outline"

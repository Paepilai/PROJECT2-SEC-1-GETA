    ...
    <div>
      ...
      /> -->
            <div>
                ...
                <input v-for="(date, index) in chosenDates" :key="index" type="date" v-model="chosenDates[index]"
                    @change="updateNights" />
            ...
            <input
                ...
                id="date" type="date" placeholder="Select a date" v-model="chosenDate" />
            <button
        ...
        <div class="max-w-md mx-auto mt-10 bg-white shadow-lg rounded-lg overflow-hidden" id="availableRest1"
            ...
            <form class="py-4 px-6" action="" method="POST">
                ...
                <button
                    class="bg-gray-900 text-white py-2 px-4 rounded hover:bg-gray-800 focus:outline-none focus:shadow-outline"
                    type="button" @click="startBooking()">
                    Book
                </button>
            </form>
        </div>
            ...
            <div class="max-w-md mx-auto mt-10 bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <form class="py-4 px-6" action="" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="message" rows="4" placeholder="Enter any additional information"
                            v-model="specialValue"></textarea>
                    </div>
                    <div class="flex items-center justify-center mb-4">
                        <button
                            class="bg-gray-900 text-white py-2 px-4 rounded hover:bg-gray-800 focus:outline-none focus:shadow-outline"
                            type="button" @click="bookReceipt()">
                            Book Camp
                        </button>
                    </div>
                </form>
        ...
        <div class="flex h-screen w-full items-center justify-center bg-gray-600" v-if="!isBook">

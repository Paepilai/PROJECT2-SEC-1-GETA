...
<template>
  <div class="grid-container">
    ...
    <div class="grid grid-cols-5 gap-4 p-6">
      ...
      <div class="btn bg-navgreen text-white hover:bg-[#F79C1D]">Lakefront</div>
      <div class="btn bg-navgreen text-white hover:bg-[#F79C1D]">Forest</div>

          ...
          >
            ...
            <div class="py-3">
              <button
                type="button"
                @click="increaseFontSize"
                class="ms-5 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-l-lg p-3 h-11 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none"
              >
                +
              </button>
              <label
                class="text-sm px-2 font-medium text-gray-900 dark:text-gray-300"
                >Fone Size</label
              >
              <button
                type="button"
            ...
            <label
              class="inline-flex items-center cursor-pointer px-4 py-2 text-sm"
            >
              <span
                class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300 py-1 px-2"
                >Dark Mode</span
              >
              <input
                type="checkbox"
